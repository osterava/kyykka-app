...
import testi from './images/yellow.png'
...
export default function Home() {
  return (
      <div className="">
        <div> 
          <Image src={r} alt="header" className="h_img" width={1000} />
        </div>
